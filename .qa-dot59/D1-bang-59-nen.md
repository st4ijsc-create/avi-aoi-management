...
| 16 | /twin/may/14: câu TUỔI dữ liệu có mặt và khớp Connected/Disconnected (đọc CHỮ) | "58 days" (cảnh:— ngăn:58 days) · Disconnected | **ĐẠT** | thước cũ đọc ngan-do-tuoi — Đợt 57 DỜI sang viên tin cậy ⇒ null ⇒ SAI OAN |
...
| 24 | deep-link /twin/may/14 (context mới): vỏ app | "Production (MES)" · canvas 1200 ms | **ĐẠT** |  |
...
| 30 | API máy 14: issue offline ageMinutes ≠ 0 | offline:84036′ | **ĐẠT** |  |
