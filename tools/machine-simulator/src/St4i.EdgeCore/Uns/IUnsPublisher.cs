...
public interface IUnsPublisher
{
    ...
    /// <c>St4i.EngineApi.Line.LineController</c>) as a RETAINED semantic-mirror message on
    ...
    /// polling the HTTP API. <paramref name="state"/> is the plain <c>St4i.EngineApi.Line.PackMlState</c>
