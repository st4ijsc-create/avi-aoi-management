...
#   `src/`: 460 lines added, 4 removed. THREE of the four removed are `///` lines and all three are the
...
# honest one is stage 5's: over `src/`, 460 added / 4 removed, of which three removed are `///` lines
