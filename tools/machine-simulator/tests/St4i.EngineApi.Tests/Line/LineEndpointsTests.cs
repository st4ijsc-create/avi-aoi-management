...
public sealed class LineEndpointsTests
{
    ...
    private static async Task<WebApplicationFactory<Program>> CreateFactoryAsync()
    {
        ...
        var connectorConfigDir = Directory.CreateTempSubdirectory("st4i-line-ep-connectorconfig-").FullName;
        ...
        try
        {
            ...
            // POST /v1/line/{command}, which WS-E made a PAID feature. A bare host has no
