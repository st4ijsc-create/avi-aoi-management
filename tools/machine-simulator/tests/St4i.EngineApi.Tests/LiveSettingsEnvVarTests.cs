...
public sealed class LiveSettingsEnvVarTests
{
        ...
        string? serverUrl, string? machineCode, string? verifyTlsRaw)
    {
        ...
        var identityDir = Directory.CreateTempSubdirectory("st4i-live-settings-identity-").FullName;
        var siteLinkDir = Directory.CreateTempSubdirectory("st4i-live-settings-sitelink-").FullName;
        ...
        var alarmsDir = Directory.CreateTempSubdirectory("st4i-live-settings-alarms-").FullName;
        ...
        var bridgeSpoolDir = Directory.CreateTempSubdirectory("st4i-live-settings-bridgespool-").FullName;
        var connectorConfigDir = Directory.CreateTempSubdirectory("st4i-live-settings-connectorconfig-").FullName;
