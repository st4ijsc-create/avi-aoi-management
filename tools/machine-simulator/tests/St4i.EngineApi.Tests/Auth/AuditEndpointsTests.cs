...
public sealed class AuditEndpointsTests
{
    ...
    private static async Task<WebApplicationFactory<Program>> CreateFactoryAsync()
    {
        ...
        var bridgeSpoolDir = Directory.CreateTempSubdirectory("st4i-audit-ep-bridgespool-").FullName;
        var connectorConfigDir = Directory.CreateTempSubdirectory("st4i-audit-ep-connectorconfig-").FullName;
