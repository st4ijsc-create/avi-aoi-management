...
public sealed class UserEndpointsTests
{
    ...
    private static async Task<WebApplicationFactory<Program>> CreateFactoryAsync()
    {
        ...
        var alarmsDir = Directory.CreateTempSubdirectory("st4i-users-ep-alarms-").FullName;
        ...
        var bridgeSpoolDir = Directory.CreateTempSubdirectory("st4i-users-ep-bridgespool-").FullName;
        var connectorConfigDir = Directory.CreateTempSubdirectory("st4i-users-ep-connectorconfig-").FullName;
