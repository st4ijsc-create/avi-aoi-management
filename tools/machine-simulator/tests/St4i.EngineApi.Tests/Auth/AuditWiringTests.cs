...
public sealed class AuditWiringTests
{
        ...
        bool demoEnabled = false, Action<IServiceCollection>? configureServices = null)
    {
        ...
        // above: this class's own FleetEstop_AsOperator_RecordsActor test (and any other route that hits
        // PolicyResults.DenyAsync) now resolves IAlarmStore and raises an alarm on a real DENY; without
        ...
        var connectorConfigDir = Directory.CreateTempSubdirectory("st4i-audit-wiring-connectorconfig-").FullName;
