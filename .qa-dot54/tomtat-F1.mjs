...
const OUT = process.env.QA_OUT ?? ".qa-dot54";
...
kq.dong.push(bang("Đợt 52 (nền QA lần 8)", gom(".qa-dot52", /^f1-52-\d+$/)));
kq.dong.push(bang("★ Đợt 53 (A+B+C)", gom(".qa-dot53", /^f1-53-\d+$/)));
...
kq.dong.push(bang("★★ Đợt 54 QA lần 9 (7 lượt)", gom(".qa-dot54", /^f1-54-\d+$/)));
