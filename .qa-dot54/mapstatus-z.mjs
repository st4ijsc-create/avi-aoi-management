...
//   Biên dịch server/services/trangThaiMayTuoiDot54Goc.ts bằng esbuild rồi gọi.
import { build } from "esbuild";
import { writeFileSync } from "node:fs";
const r = await build({ entryPoints: ["server/services/trangThaiMayTuoiDot54Goc.ts"], bundle: true, format: "esm", platform: "node", write: false, packages: "external" });
...
const cases = [
  ...
  ["maintenance", "maintenance"], ["error", "error"], ["warming_up", "warming_up"], ["XAP_XI", m.null],
];
