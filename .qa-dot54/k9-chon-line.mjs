...
const BASE=arg("base","http://localhost:3054"); const VPS=arg("vp","1600x900,1280x720").split(",");
const OUT=".qa-dot54/k9"; mkdirSync(OUT,{recursive:true});
...
for(const vp of VPS){
 ...
 await ctx.addCookies(JSON.parse(readFileSync(".qa-dot54/state-e2e_tai_loE.json","utf8")));
