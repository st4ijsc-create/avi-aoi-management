...
//   node .qa-dot48/bbox45.mjs --tag=truoc|sau|go-<muc> [--base=http://localhost:3048] [--lang=vi]
// Ghi .qa-dot48/bbox-<tag>.json + in "[vp] M<n> ĐẠT|TRƯỢT chi tiết". Mỗi mục có tiêu chí NÓI RA ở đầu hàm.
...
writeFileSync(`.qa-dot48/bbox-${TAG}.json`, JSON.stringify(kq, null, 2));
