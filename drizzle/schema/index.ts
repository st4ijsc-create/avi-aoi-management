...
export * from "./machineOperatingConfig"; // Task 6 (machine-config plan) — machine-reported ACTUAL operating config (baseline⊕machine⊕machine×product), migration 0298
