...
export function KhungCanh({
  ...
  // ★★★ PH-50b — `near` KHÔNG còn là hằng 0,1: nó đi theo `far` để nới `far` không
  ...
  // ★ PH-50b — phơi mặt phẳng cắt TRANG YÊU CẦU. Ở NGOÀI `<Canvas>`: nó phải còn đúng
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {/* ★★★ PH-50b — prop `camera` chỉ là cấu hình KHỞI TẠO; đây mới là chỗ `far` tới camera. */}
