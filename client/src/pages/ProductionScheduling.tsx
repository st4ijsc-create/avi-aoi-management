                  ...
                  <Card key={i}>
                    <CardHeader className="pb-3">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge variant={wip.utilizationRate > 80 ? "destructive" : wip.utilizationRate > 50 ? "default" : "secondary"}>
                          {wip.utilizationRate.toFixed(0)}% {t("scheduling.utilization", "công suất")}
                        </Badge>
                      </div>
                    </CardHeader>
                    <CardContent className="space-y-3">
                      ...
                      <div>
                        <div className="flex justify-between text-sm mb-1">
                          ...
                          <span className="font-semibold">{wip.completionPercentage.toFixed(1)}%</span>
                        </div>
                        <Progress value={wip.completionPercentage} className="h-2" />
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">{t("scheduling.quantity", "Sản lượng")}</span>
                        <span className="font-mono">
                          {wip.totalActualQuantity.toLocaleString()} / {wip.totalTargetQuantity.toLocaleString()}
                        </span>
                      </div>
