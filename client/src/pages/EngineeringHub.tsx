 ...
 * này gom theo TÁC VỤ thành 4 nhóm (soạn thảo · điều phối · an toàn & chuẩn hóa ·
 * twin & mô phỏng) + một dải "luồng vàng" nêu rõ mạch soạn → mô phỏng → deploy →
 * giám sát để các editor chồng lấn không còn mơ hồ "dùng cái nào".
 *
...
// 4 nhóm tác vụ — thứ tự & thành phần khớp navigation.tsx group "engineering".
