...
export const navGroups: NavGroup[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      // doc 36 follow-up — bóc menu-trong của /dashboard-center ra menu trái (deep-links).
      {
        href: "/dashboard-center?tab=custom-dashboard",
        label: "dashboardCenter.sidebar.customDashboard",
      ...
      {
        href: "/dashboard-center?tab=dashboard-templates",
        label: "dashboardCenter.sidebar.dashboardTemplates",
      ...
      },
      {
        ...
        label: "dashboardCenter.sidebar.dashboardMarketplace",
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      },
      {
        ...
        // "Quản lý thiết bị" (device-management) cần deep-link riêng.
  ...
  // ──────────────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      {
        href: "/datasettings?tab=workshops",
        label: "settings.sidebar.workshop",
        icon: <Warehouse className="h-4 w-4" />,
        description: "nav.dataSettingsPageDesc",
        requiredPermission: "settings_factory",
        permissionCategory: "settings",
      ...
      {
        href: "/datasettings?tab=machines",
        label: "settings.sidebar.inspectionMachine",
        icon: <Cpu className="h-4 w-4" />,
        description: "nav.dataSettingsPageDesc",
        requiredPermission: "settings_factory",
        permissionCategory: "settings",
      ...
      {
        href: "/datasettings?tab=product-categories",
        label: "settings.sidebar.productCategory",
        icon: <Tags className="h-4 w-4" />,
        description: "nav.dataSettingsPageDesc",
        requiredPermission: "settings_factory",
        permissionCategory: "settings",
      ...
      // doc 36 follow-up — bóc menu-trong của /settings ra menu trái (tab nội bộ, không route).
      {
        href: "/settings?tab=yield-thresholds",
        label: "settings.sidebar.yield",
        icon: <Target className="h-4 w-4" />,
        description: "nav.generalSettingsDesc",
        requiredPermission: "settings_view",
        permissionCategory: "settings",
      ...
      {
        href: "/settings?tab=report-templates",
        label: "settings.sidebar.reportTemplate",
        icon: <FileText className="h-4 w-4" />,
        description: "nav.generalSettingsDesc",
        requiredPermission: "settings_view",
        permissionCategory: "settings",
      ...
      },
      {
        ...
        label: "settings.sidebar.notificationSounds",
        icon: <Bell className="h-4 w-4" />,
        description: "nav.generalSettingsDesc",
        requiredPermission: "settings_view",
        permissionCategory: "settings",
      ...
      // doc 36 follow-up — bóc menu-trong của /admin-setting ra menu trái (tab nội bộ, không route).
      {
        href: "/admin-setting?tab=permissions",
        label: "adminSettings.sidebar.permissions",
      ...
      {
        href: "/admin-setting?tab=roles",
        label: "adminSettings.sidebar.roles",
        icon: <ShieldCheck className="h-4 w-4" />,
        description: "nav.adminSettingDesc",
        requiredRole: 'admin',
        requiredPermission: "admin_system",
      ...
      {
        href: "/admin-setting?tab=smtp-config",
        label: "adminSettings.sidebar.smtpConfig",
        icon: <Server className="h-4 w-4" />,
        description: "nav.adminSettingDesc",
        requiredRole: 'admin',
        requiredPermission: "admin_system",
      ...
      {
        href: "/admin-setting?tab=email-template",
        label: "adminSettings.sidebar.emailTemplate",
      ...
      {
        href: "/admin-setting?tab=cache-stats",
        label: "adminSettings.sidebar.cacheStats",
        icon: <Database className="h-4 w-4" />,
        description: "nav.adminSettingDesc",
        requiredRole: 'admin',
        requiredPermission: "admin_system",
