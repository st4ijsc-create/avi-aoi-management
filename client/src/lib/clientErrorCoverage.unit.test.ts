...
const ALLOWED_RAW_MESSAGE_HANDLERS = 0; // ← Task 8 lượt D, lô 6/CUỐI (7 file 1-site): 7 → 0 (7 site, xem task-8d-report.md). Sprint 5 F1/F4 đóng — mọi onError mới hiện chuỗi thô sẽ làm đỏ cổng ngay.
