...
//   node .qa-dot49/thigiac46.mjs --lang=vi [--base=http://localhost:3049] [--vp=1600x900,1280x720]
...
const OUT = process.env.QA_OUT ?? `.qa-dot50/d3-${LANG}`;
...
async function dangNhap(ctx) {
  const f = process.env.QA_STATE ?? `.qa-dot50/state-${TK.username}.json`;
