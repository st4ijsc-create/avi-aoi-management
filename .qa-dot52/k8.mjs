...
//   Ghi thô: .qa-dot52/k8/*.json + PNG.  node .qa-dot52/k8.mjs --base=http://localhost:3052 [--vp=...] [--tag=k8] [--fc=1] [--so=5]
...
const OUT = ".qa-dot52/k8"; mkdirSync(OUT, { recursive: true });
...
async function dangNhap(ctx) {
  const f = `.qa-dot52/state-${TK.username}.json`;
