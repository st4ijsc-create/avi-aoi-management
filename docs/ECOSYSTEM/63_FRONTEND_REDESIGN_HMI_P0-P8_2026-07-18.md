...
| **Inc-1b** | Wire FreshnessStrip vào shell header + tile-desaturation FEA-F2 + PackML/E10 badges FEA-M + alarm 4-field FEA-A1 + token oklch→index.css | live Playwright panel-PC viewport |
