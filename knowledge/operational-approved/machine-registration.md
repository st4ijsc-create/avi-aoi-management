...
# Đăng ký máy — xử lý sự cố & thao tác

## Thông tin đã xác minh từ mã nguồn
- **Đường dẫn**: `/machine-registration`
- **Menu**: Thiết bị & Giám sát › Đăng ký máy
...
1. Mở `/machine-registration` (menu: Thiết bị & Giám sát › Đăng ký máy).
