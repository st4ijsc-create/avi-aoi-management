...
/**
 * Cấu hình Playwright RIÊNG cho **Đợt 23** — chỉ khác bản gốc ở `outputDir`
 * và `baseURL`.
 *
 * ════════════════════════════════════════════════════════════════════════════
 ...
 *
 * ⇒ Mọi lượt chạy của Đợt 23 dùng tệp này, và **sau lượt cuối** phải kiểm
 ...
 *
 * ⚠ Cổng 3142 là cổng RIÊNG của Đợt 23. Cổng 3000 thuộc phiên khác — không đụng.
 */
const baseURL = process.env.PLAYWRIGHT_BASE_URL || "http://127.0.0.1:3142";
